...
var SnapShotBox = /** @class */ (function () {
    ...
    SnapShotBox.prototype.unbox = function () {
        var _a;
        if (this.snapshot instanceof type_mapper_1.firestore.DocumentSnapshot) {
            if (!this.snapshot.exists) {
                return null;
            }
            return [__assign((_a = { id: this.snapshot.id }, _a[exports.documentReferencePath] = this.snapshot.ref, _a), this.snapshot.data())];
        }
        else if (this.snapshot instanceof type_mapper_1.firestore.QuerySnapshot) {
    ...
    FirestoreReference.prototype.set = function (params) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(this.ref instanceof type_mapper_1.firestore.DocumentReference)) return [3 /*break*/, 4];
                        if (!this.transaction) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.transaction.set(this.ref, params)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                    case 2: return [4 /*yield*/, this.ref.set(params)];
                    case 3:
                        _a.sent();
                        return [2 /*return*/];
