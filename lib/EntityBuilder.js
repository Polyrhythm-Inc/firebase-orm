...
var FirestoreReference = /** @class */ (function () {
    ...
    FirestoreReference.prototype.update = function (params) {
        return __awaiter(this, void 0, void 0, function () {
            var ref;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        ref = this.ref;
                        if (!this.transaction) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.transaction.update(ref, params)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                    case 2: return [4 /*yield*/, ref.update(params)];
                    case 3:
                        _a.sent();
                        return [2 /*return*/];
                    case 4: throw new Error('reference should be DocumentReference');
...
function buildEntity(meta, data, reference, options) {
    var _a, _b, _c;
    return __awaiter(this, void 0, void 0, function () {
        var groupedRelations, plain, _i, _d, relation, _e, _f, setting, keyInForestore, relation, rawRef, hierarchy, relation, hierarchy, relation, rawRef, hierarchy, hierarchy, relation, hierarchy, instance, key;
        return __generator(this, function (_g) {
            switch (_g.label) {
                case 0:
                    groupedRelations = (options === null || options === void 0 ? void 0 : options.relations) ? relationToGroup(options.relations) : {};
                    plain = {};
                    for (_i = 0, _d = Object.keys(groupedRelations); _i < _d.length; _i++) {
                        relation = _d[_i];
                        if (!meta.columns.map(function (x) { return x.propertyKey; }).includes(relation)) {
                            throw new RelationNotFoundError(relation);
                        }
                    }
                    _e = 0, _f = meta.columns;
                    _g.label = 1;
                case 1:
                    if (!(_e < _f.length)) return [3 /*break*/, 14];
                    setting = _f[_e];
                    keyInForestore = getName(setting) || setting.propertyKey;
                ...
                case 5:
                    ...
                    if (!((_b = setting.option) === null || _b === void 0 ? void 0 : _b.joinColumnName)) return [3 /*break*/, 7];
                    keyInForestore = setting.option.joinColumnName;
                    rawRef = data[keyInForestore];
                    return [4 /*yield*/, followHierarchy({
                            setting: setting,
                ...
                case 6:
                    ...
                    return [3 /*break*/, 9];
                case 7:
                    if (!((_c = setting.option) === null || _c === void 0 ? void 0 : _c.relationColumn)) return [3 /*break*/, 9];
                    return [4 /*yield*/, followHierarchy({
                            setting: setting,
                            relations: {
                                top: setting.propertyKey,
                ...
                case 10:
                    if (!(setting instanceof Entity_1._ArrayReference)) return [3 /*break*/, 12];
                    relation = groupedRelations[setting.propertyKey];
                    if (!relation) {
                        return [3 /*break*/, 13];
                    }
...
function followHierarchy(params) {
    var _a, _b, _c, _d;
    return __awaiter(this, void 0, void 0, function () {
        var results, _e, ref, box, unboxed, meta, _f, _g, singleRef_1, singlRepo, _h, _j, manyRepo, _k, _l, refs, _m, _o;
        return __generator(this, function (_p) {
            switch (_p.label) {
                ...
                case 8:
                    ...
                    return [3 /*break*/, 11];
                case 9:
                    refs = params.fetchMode.references.map(function (ref) { var _a; return new FirestoreReference(ref, (_a = params.reference) === null || _a === void 0 ? void 0 : _a.transaction); });
                    _m = results;
                    _o = params.setting.propertyKey;
                    return [4 /*yield*/, Promise.all(refs.map(function (ref) {
                            return ref.get().then(function (box) {
                                var unboxed = box.unbox();
                                if (unboxed && unboxed[0]) {
                                    var meta = Entity_1.findMeta(params.setting.getEntity());
