...
(function () { return __awaiter(void 0, void 0, void 0, function () {
    var serviceAccount, db;
    return __generator(this, function (_a) {
        serviceAccount = require("../../polyrhythm-dev-example-firebase-adminsdk-ed17d-e1dd189e07.json");
        admin.initializeApp({
        ...
        Repository_1.getRepository(User_1.User).prepareFetcher(function (db) {
            return db.limit(5);
