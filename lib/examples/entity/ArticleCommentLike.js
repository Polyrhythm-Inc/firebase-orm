...
var ArticleComment_1 = require("./ArticleComment");
var ArticleCommentLike = /** @class */ (function () {
    function ArticleCommentLike() {
    }
    __decorate([
    ...
    ArticleCommentLike = __decorate([
        Entity_1.NestedFirebaseEntity('article_comment_likes', function () { return Article_1.Article; }, function () { return ArticleComment_1.ArticleComment; })
    ], ArticleCommentLike);
