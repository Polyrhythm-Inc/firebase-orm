...
var FirebaseEntitySerializer = /** @class */ (function () {
    ...
    FirebaseEntitySerializer.serializeToJSON = function (object, parentId, options) {
        var _a;
...
var FirebaseEntityDeserializer = /** @class */ (function () {
    ...
    FirebaseEntityDeserializer.deserializeFromJSON = function (Entity, object, parentId, options) {
        ...
        var _loop_1 = function (key) {
            ...
            if (item[exports.referenceCluePath]) {
                ...
                if ((options === null || options === void 0 ? void 0 : options.stringToTimeStamp) && column instanceof Entity_1._ColumnSetting && column.columnType.now) {
