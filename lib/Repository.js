...
var Repository = /** @class */ (function () {
    function Repository(Entity, transaction, parentIdMapper, db) {
        this.Entity = Entity;
    ...
    Repository.prototype.fetchOneById = function (id, options) {
        return this.prepareFetcher(function (ref) { return ref.doc(id); }).fetchOne(options);
    };
    Repository.prototype.fetchOneByIdOrFail = function (id, options) {
        return this.prepareFetcher(function (ref) { return ref.doc(id); }).fetchOneOrFail(options);
    };
    Repository.prototype.fetchAll = function (options) {
        return this.prepareFetcher(function (ref) { return ref; }).fetchAll(options);
    };
    Repository.prototype.onSnapShot = function (callback, options) {
        return this.prepareFetcher(function (ref) { return ref; }).onSnapShot(callback, options);
    };
...
var TransactionManager = /** @class */ (function () {
    ...
    TransactionManager.prototype.getRepository = function (Entity, params, db) {
        if (params) {
