...
var Repository = /** @class */ (function () {
    function Repository(Entity, transaction) {
        this.Entity = Entity;
    ...
    Repository.prototype.prepareFetcher = function (condition) {
        ...
        var ref = new EntityBuilder_1.FirestoreReference(condition(getCurrentDB().collection(meta.tableName)), this.transaction);
        return new Fetcher(meta, ref);
    };
    Repository.prototype.prepareUpdate = function (condition) {
        var meta = Entity_1.findMeta(this.Entity);
        var ref = new EntityBuilder_1.FirestoreReference(condition(getCurrentDB().collection(meta.tableName)), this.transaction);
        return new Fetcher(meta, ref);
    };
    Repository.prototype.fetchOneById = function (id, options) {
        return this.prepareFetcher(function (db) {
            return db.doc(id);
        }).fetchOne(options);
    };
    Repository.prototype.fetchAll = function (options) {
        return this.prepareFetcher(function (db) { return db; }).fetchAll(options);
    };
    Repository.prototype.onSnapShot = function (callback, options) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.prepareFetcher(function (db) { return db; }).onSnapShot(callback, options)];
            });
        });
    };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        _ref = getCurrentDB().collection(meta.tableName).doc(resource.id);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 5:
                        meta = Entity_1.findMeta(this.Entity);
                        ref_1 = getCurrentDB().collection(meta.tableName).doc(resourceOrId);
...
var TransactionManager = /** @class */ (function () {
    ...
    TransactionManager.prototype.getRepository = function (Entity) {
